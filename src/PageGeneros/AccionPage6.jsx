import { AccionPage6 } from "../pages/GeneroPage";

export function AccionPageSexto() {
  return (
    <div>
      ...
      <div className="paginacion-contenedor">
        <ul>
          <a href="/generos[]=accion&page=5" className="anterior">
            Anterior
          </a>
          <li>
          ...
          <a href="/generos[]=accion&page=7" className="siguiente">
            Siguiente
          </a>
        </ul>
      </div>
