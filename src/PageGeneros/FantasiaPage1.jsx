import { FantasiaPage1 } from "../pages/GeneroPage";

export function FantasiaPageOne() {
  return (
    <div>
      ...
      <div className="paginacion-contenedor">
        <ul>
          <li className="active">
            <a href="/generos[]=fantasia">1</a>
          </li>
          <li>
            <a href="/generos[]=fantasia&page=2">2</a>
          </li>
          <li className="paginacion">
            <a href="/generos[]=fantasia&page=3">3</a>
          </li>
          <li className="paginacion">
            <a href="/generos[]=fantasia&page=4">4</a>
          </li>
          <li className="paginacion">
            <a href="/generos[]=fantasia&page=5">5</a>
          </li>
          <li className="paginacion">
            <a href="/generos[]=fantasia&page=6">6</a>
          </li>

          <a href="/generos[]=fantasia&page=2" className="siguiente">
            Siguiente
          </a>
        </ul>
      </div>
