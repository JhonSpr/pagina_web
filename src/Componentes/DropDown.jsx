...
<div className="dropdown filter-item">
  ...
  <ul className="dropdown-menu dropdown-menu-dark">
    <li><a className={finalizado} href="estado=finalizado">FINALIZADO</a></li>
    <li><a className={enEmision} href="estado=en-emision">EN EMISIÓN</a></li>
    <li><a className={proximamente} href="estado=proximamente">PROXIMAMENTE</a></li>
...
<div className="dropdown filter-item">
  ...
  <ul className="dropdown-menu dropdown-menu-dark">
    <li><a className="dropdown-item" href="/animes">TV</a></li>
