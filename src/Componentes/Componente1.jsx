...
export function Componente1({year1,year2,year3,year4,year5,year6,year7,year8,year9,year10,year11,year12,year13,year14,year15,year16,year17,year18,year19,year20,year21,year22,
...
<i className="fa-solid fa-filter"></i>
  ...
  <ul className="dropdown-menu dropdown-menu-dark contenedor-dropdown">
    <li><NavLink className="dropdown-item" to={"/generos=accion"}>Aacción</NavLink></li>
    <li><NavLink className="dropdown-item" to={"/generos=fantasia"}>Fantasia</NavLink></li>
    <li><NavLink className="dropdown-item" to={"/generos=terror"}>Terror</NavLink></li>
    <li><NavLink className="dropdown-item" to="/generos=juegos">Juegos</NavLink></li>
    <li><NavLink className="dropdown-item" to="/generos=aventura">Aventura</NavLink></li>
    <li><NavLink className="dropdown-item" to="/generos=drama">Drama</NavLink></li>
    <li><NavLink className="dropdown-item" to="/generos=harem">Harem</NavLink></li>
    <li><NavLink className="dropdown-item" to="/generos=seinen">Seinen</NavLink></li>
    <li><NavLink className="dropdown-item" to="/generos=romance">Romance</NavLink></li>
    <li><NavLink className="dropdown-item" to="/generos=samurai">Samurai</NavLink></li>
    <li><NavLink className="dropdown-item" to="/generos=ciencia-ficcion">Ciencia Ficción</NavLink></li>
    <li><NavLink className="dropdown-item" to="/generos=deportes">Deportes</NavLink></li>
    <li><NavLink className="dropdown-item" to="/generos=escolares">Escolares</NavLink></li>
    <li><NavLink className="dropdown-item" to="/generos=misterio">Misterio</NavLink></li>
    <li><NavLink className="dropdown-item" to="/generos=sei-fi">Sei-Fi</NavLink></li>
    <li><NavLink className="dropdown-item" to="/generos=shounen">Shounen</NavLink></li>
    <li><NavLink className="dropdown-item" to="/generos=ninjas">Ninjas</NavLink></li>
    <li><NavLink className="dropdown-item" to="/generos=dragones">Dragones</NavLink></li>
    <li><NavLink className="dropdown-item" to="/generos=comedia">Comedia</NavLink></li>
    <li><NavLink className="dropdown-item" to="/generos=vampiros">Vampiros</NavLink></li>
    <li><NavLink className="dropdown-item" to="/generos=yaoi">Yaoi</NavLink></li>
    <li><NavLink className="dropdown-item" to="/generos=shouju">Shouju</NavLink></li>
    <li><NavLink className="dropdown-item" to="/generos=parodia">Parodia</NavLink></li>
    <li><NavLink className="dropdown-item" to="/generos=gore">Gore</NavLink></li>
    <li><NavLink className="dropdown-item" to={"/generos=cyberpunk"}>CyberPunk</NavLink></li>
    <li><NavLink className="dropdown-item" to={"/generos=artes-marciales"}>Artes Marciales</NavLink></li>
    <li><NavLink className="dropdown-item" to={"/generos=militar"}>Militar</NavLink></li>
    <li><NavLink className="dropdown-item" to={"/generos=isekai"}>Isekai</NavLink></li>
    <li><NavLink className="dropdown-item" to={"/generos=demonios"}>Demonios</NavLink></li>
    <li><NavLink className="dropdown-item" to={"/generos=magia"}>Magia</NavLink></li>
  </ul>
</div>
...
<div className="dropdown filter-item">
  ...
  <ul className="dropdown-menu dropdown-menu-dark">
    <li><NavLink className="dropdown-item" to="estado=finalizado">FINALIZADO</NavLink></li>
    <li><NavLink className="dropdown-item" to="/en-emision">EN EMISIÓN</NavLink></li>
    <li><NavLink className="dropdown-item" to="estado=proximamente">PROXIMAMENTE</NavLink></li>
...
<div className="dropdown filter-item">
  ...
  <ul className="dropdown-menu dropdown-menu-dark">
    <li><NavLink className="dropdown-item active" to="/animes">TV  ( Predeterminado )</NavLink></li>
    <li><NavLink className="dropdown-item" to="/animes/tipo=ova">OVA</NavLink></li>
    <li><NavLink className="dropdown-item" to="/animes/tipo=pelicula">PELICULA</NavLink></li>
...
<div className="dropdown filter-item">
  ...
  <ul className="dropdown-menu dropdown-menu-dark contenedor-años">
    <li><NavLink className="dropdown-item" to="/animes/year=2022">2022</NavLink></li>
    <li><NavLink className="dropdown-item" to="/animes/year=2021">2021</NavLink></li>
    <li><NavLink className="dropdown-item" to="/animes/year=2020">2020</NavLink></li>
    <li><NavLink className="dropdown-item" to="/animes/year=2019">2019</NavLink></li>
    <li><NavLink className="dropdown-item" to="/animes/year=2018">2018</NavLink></li>
    <li><NavLink className="dropdown-item" to="/animes/year=2017">2017</NavLink></li>
    <li><NavLink className="dropdown-item" to="/animes/year=2016">2016</NavLink></li>
    <li><NavLink className="dropdown-item" to="/animes/year=2015">2015</NavLink></li>
    <li><NavLink className="dropdown-item" to="/animes/year=2014">2014</NavLink></li>
    <li><NavLink className="dropdown-item" to="/animes/year=2013">2013</NavLink></li>
    <li><NavLink className="dropdown-item" to="/animes/year=2012">2012</NavLink></li>
    <li><NavLink className="dropdown-item" to="/animes/year=2011">2011</NavLink></li>
    <li><NavLink className="dropdown-item" to="/animes/year=2010">2010</NavLink></li>
  ...
  <article className="serie-card" title={anime2}>
    ...
    <figure className="image overarchingdiv2">
        ...
        <div className="title">
            <h3><NavLink to={href2} className="has-text-orange has-text-weight-semibold has-text-centered is-size-6">{anime2}</NavLink></h3>
        </div>
    </figure>
  </article>
  <article className="serie-card" title={anime3}>
    <figure className="image overarchingdiv2">
        ...
        <div className="title">
            <h3><NavLink to={href3} className="has-text-orange has-text-weight-semibold has-text-centered is-size-6">{anime3}</NavLink></h3>
        </div>
    </figure>
  </article>
  <article className="serie-card" title={anime4}>
    <figure className="image overarchingdiv2">
        ...
        <div className="title">
            <h3><NavLink to={href4} className="has-text-orange has-text-weight-semibold has-text-centered is-size-6">{anime4}</NavLink></h3>
        </div>
    </figure>
  </article>
  ...
  <article className="serie-card" title={anime14}>
    <figure className="image overarchingdiv2">
        ...
        <div className="title">
            <h3><NavLink to={href14} className="has-text-orange has-text-weight-semibold has-text-centered is-size-6">{anime14}</NavLink></h3>
        </div>
    </figure>
  </article>
  <article className="serie-card" title={anime15}>
    <figure className="image overarchingdiv2">
        ...
        <div className="title">
            <h3><NavLink to={href15} className="has-text-orange has-text-weight-semibold has-text-centered is-size-6">{anime15}</NavLink></h3>
        </div>
    </figure>
  </article>
  <article className="serie-card" title={anime16}>
    <figure className="image overarchingdiv2">
        ...
        <div className="title">
            <h3><NavLink to={href16} className="has-text-orange has-text-weight-semibold has-text-centered is-size-6">{anime16}</NavLink></h3>
        </div>
    </figure>
  </article>
  <article className="serie-card" title={anime17}>
    <figure className="image overarchingdiv2">
        ...
        <div className="title">
            <h3><NavLink to={href17} className="has-text-orange has-text-weight-semibold has-text-centered is-size-6">{anime17}</NavLink></h3>
        </div>
    </figure>
  </article>
  <article className="serie-card" title={anime18}>
    <figure className="image overarchingdiv2">
        ...
        <div className="title">
            <h3><NavLink to={href18} className="has-text-orange has-text-weight-semibold has-text-centered is-size-6">{anime18}</NavLink></h3>
        </div>
    </figure>
  </article>
  <article className="serie-card" title={anime19}>
    <figure className="image overarchingdiv2">
        ...
        <div className="title">
            <h3><NavLink to={href19} className="has-text-orange has-text-weight-semibold has-text-centered is-size-6">{anime19}</NavLink></h3>
        </div>
    </figure>
  </article>
  <article className="serie-card" title={anime20}>
    <figure className="image overarchingdiv2">
        ...
        <div className="title">
            <h3><NavLink to={href20} className="has-text-orange has-text-weight-semibold has-text-centered is-size-6">{anime20}</NavLink></h3>
        </div>
    </figure>
  </article>
  <article className="serie-card" title={anime21}>
    <figure className="image overarchingdiv2">
        ...
        <div className="title">
            <h3><NavLink to={href21} className="has-text-orange has-text-weight-semibold has-text-centered is-size-6">{anime21}</NavLink></h3>
        </div>
    </figure>
  </article>
  <article className="serie-card" title={anime22}>
    <figure className="image overarchingdiv2">
        ...
        <div className="title">
            <h3><a to={href22} className="has-text-orange has-text-weight-semibold has-text-centered is-size-6">{anime22}</a></h3>
        </div>
    </figure>
  </article>
  <article className="serie-card" title={anime23}>
    <figure className="image overarchingdiv2">
        ...
        <div className="title">
            <h3><NavLink to={href23} className="has-text-orange has-text-weight-semibold has-text-centered is-size-6">{anime23}</NavLink></h3>
        </div>
    </figure>
  </article>
  <article className="serie-card" title={anime24}>
    <figure className="image overarchingdiv2">
       ...
       <span className={classEmision24}>{emision}</span>
        <div className="title">
            <h3><NavLink to={href24} className="has-text-orange has-text-weight-semibold has-text-centered is-size-6">{anime24}</NavLink></h3>
        </div>
    </figure>
  </article>
