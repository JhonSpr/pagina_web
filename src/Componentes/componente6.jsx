...
export function Animes6(){
    return (
        <div>
            <Routes>
            -----------------
         
         <Route path="/ver/tokyo-ghoul" element={<Capitulos12 tituloAnime={"Tokyo Ghoul"} 
        ...
        anime={"Tokyo Ghoul"} tipo={"TV"} numeroEpisodios={""} estado={"Finalizado"}  
        imagenAnime={""} 
